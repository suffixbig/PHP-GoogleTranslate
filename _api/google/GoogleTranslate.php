...
class GoogleTranslate
{
    ...
    protected static function requestTranslation($source, $target, $text)
    {
        ...
        $url = "https://translate.google.com.tw/translate_a/single?client=at&dt=t&dt=ld&dt=qca&dt=rm&dt=bd&dj=1&hl=es-ES&ie=UTF-8&oe=UTF-8&inputm=2&otf=2&iid=1dd3b944-fa62-4b55-b330-74909a99969e";
        ...
        curl_setopt($ch, CURLOPT_USERAGENT, 'Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; rv:11.0) like Gecko');//IE11
        // Execute post
        $result = curl_exec($ch);
