...
$dir = dirname(__FILE__) . "\\01a"; //要開啟的路徑
...
$url = 'https://translation.googleapis.com/language/translate/v2?key=AIzaSyBTsdfdsfdscv5Gxw9khit2RNdRLWldwuw';
/*********************************************************************************************/

$filenames = get_filenamesbydir($dir); //獲取目錄下所有文件，包括子目錄
